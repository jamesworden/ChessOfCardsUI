import { AnimatedMovement } from '../../../views/game-view/components/animation-overlay/models/animated-movement.model';
import { AnimatedPosition } from '../../../views/game-view/components/animation-overlay/models/animated-position.model';
import {
  AnimatedEntity,
  AnimatedEntityStyles,
} from '../../../views/game-view/components/animation-overlay/models/animated-entity.model';
import { TemplateRef } from '@angular/core';
import { AnimationType } from '../../../views/game-view/components/animation-overlay/models/animation-type.model';
...
import { MoveMadeDetails } from '../../../views/game-view/models/move-made-details.model';
